            ...
            <div id="customizer-content" style="display: none;">
                ...
                <div class="customizer-row">
                    <div class="customizer-section">
                        ...
                        <input type="number" id="cust-age" value="${
                          this.config.age
                        }" min="1" max="150">
                    </div>
                    <div class="customizer-section">
                        <label for="cust-date">Date:</label>
                        <input type="text" id="cust-date" value="${
                          this.config.date
                ...
                <div class="customizer-section">
                    ...
                    <input type="url" id="cust-image" value="${
                ...
                <div class="customizer-section">
                    ...
                    <input type="text" id="cust-creator" value="${
                      this.config.creator
                    }">
                </div>
                    ...
                    <select id="cust-theme">
                        ${Object.keys(this.themes)
                          .map(
                            (theme) =>
                              `<option value="${theme}" ${
                                theme === this.config.theme ? "selected" : ""
                    ...
                    <div class="music-toggle">
                        <label>
                            <input type="checkbox" id="music-enabled" ${
                              this.config.music.enabled ? "checked" : ""
                            }>
                            Enable Background Music
                        </label>
                    </div>
                    
                    <div id="music-controls" style="display: ${
                      this.config.music.enabled ? "block" : "none"
                    };">
                        <div class="customizer-section">
                            <label for="music-track">Music Track:</label>
                            <select id="music-track">
                                <option value="default" ${
                                  this.config.music.selectedTrack === "default"
                                    ? "selected"
                                    : ""
                                }>Happy Birthday Classic</option>
                                <option value="party" ${
                                  this.config.music.selectedTrack === "party"
                                    ? "selected"
                                    : ""
                                }>Party Time</option>
                                ...
                                <option value="ambient" ${
                                  this.config.music.selectedTrack === "ambient"
                                    ? "selected"
                                    : ""
                                }>Ambient Birthday</option>
                                <option value="custom" ${
                                  this.config.music.selectedTrack === "custom"
                                    ? "selected"
                                    : ""
                                }>Custom URL</option>
                            </select>
                        ...
                        <div id="custom-music-url" style="display: ${
                          this.config.music.selectedTrack === "custom"
                            ? "block"
                            : "none"
                        };">
                            <div class="customizer-section">
                                ...
                                <input type="url" id="music-url" value="${
                                  this.config.music.customUrl
                        ...
                        <div class="customizer-section">
                            ...
                            <input type="range" id="music-volume" min="0" max="1" step="0.1" value="${
                        ...
                        <div class="music-toggle">
                            <label>
                                <input type="checkbox" id="music-autoplay" ${
                                  this.config.music.autoplay ? "checked" : ""
                                }>
                ...
                ${Object.keys(this.config.gifts)
                  .map(
                    ...
                    <div class="gift-customizer">
                        <h5>Gift ${index + 1}:</h5>
                        <input type="text" id="cust-${giftKey}-title" value="${
                      this.config.gifts[giftKey].title
                    }" placeholder="Gift title">
                        <input type="url" id="cust-${giftKey}-image" value="${
